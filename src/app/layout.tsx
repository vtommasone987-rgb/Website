      ...
      <body className="flex min-h-full flex-col">
        <header className="sticky top-0 z-10 border-b border-slate-200/70 bg-[var(--background)]/80 backdrop-blur-md dark:border-slate-800/70">
          ...
          <nav className="mx-auto grid max-w-7xl grid-cols-[1fr_auto_1fr] items-center gap-4 px-6 py-4">
            ...
            <Link
              href="/shop"
              className="justify-self-center rounded-full px-4 py-2 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-200/60 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800/60 dark:hover:text-slate-50"
            >
              Shop
            </Link>
            ...
            <div className="flex items-center justify-self-end gap-2">
              <Link
                href="/contact"
                className="flex items-center gap-2 rounded-full bg-orange-500 px-4 py-2 text-sm font-semibold whitespace-nowrap text-slate-900 shadow-[inset_0_1px_0_0_rgb(255_255_255_/_0.3),0_1px_2px_0_rgb(15_23_42_/_0.2)] transition-colors hover:bg-orange-400"
              >
              ...
              <Link
                href="/admin/login"
                aria-label="Sign in"
                className="surface flex items-center gap-2 rounded-full px-3 py-2 text-sm font-medium whitespace-nowrap transition-colors hover:border-slate-400 sm:px-4 dark:hover:border-slate-600"
              >
